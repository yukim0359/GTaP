...
RESULTS_FILE="$COMPARE_DIR/${BENCHMARK_NAME}_mem_results.csv"
echo "mem_ops,GTAP_block_med,GTAP_block_err_low,GTAP_block_err_high,GTAP_thread_med,GTAP_thread_err_low,GTAP_thread_err_high,OMP_med,OMP_err_low,OMP_err_high" > "$RESULTS_FILE"

# Pretty header (fixed width columns)
printf "%8s | %25s | %25s | %25s\n" "mem_ops" "GTAP_block (ms)" "GTAP_thread (ms)" "OpenMP (ms)"
printf "%8s-+-%25s-+-%25s-+-%25s\n" "--------" "-------------------------" "-------------------------" "-------------------------"
