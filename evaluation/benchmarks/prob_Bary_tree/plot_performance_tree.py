...
# This file lives under <workspace>/gtap/evaluation/benchmarks/<bench>/,
    ...
    if df_mem_all is not None:
        ...
        if "depth" in df_mem_all.columns:
            ...
            make_combined_plot(
                ...
                title="Varying mem_ops (D=32, compute_iters=256 fixed)",
            )
    ...
    if df_comp_all is not None:
        ...
        if "depth" in df_comp_all.columns:
            ...
            make_combined_plot(
                ...
                title="Varying compute_iters (D=32, mem_ops=0 fixed)",
            )
