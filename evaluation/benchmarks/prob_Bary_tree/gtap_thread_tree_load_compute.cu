...
#define GTAP_BENCH_GRID_SIZE 2000
#endif
...
// independently with probability p(d) = 1 - d/D.
//
...
int main(int argc, char** argv) {
    ...
    st = gtap_launch(exec_kernel, height, B, mem_ops, compute_iters);
    if (st != cudaSuccess) {
