...
RESULTS_FILE="$COMPARE_DIR/${BENCHMARK_NAME}_compute_results_seqmem.csv"
echo "compute_iters,GTAP_block_seqmem_med,GTAP_block_seqmem_err_low,GTAP_block_seqmem_err_high,GTAP_thread_seqmem_med,GTAP_thread_seqmem_err_low,GTAP_thread_seqmem_err_high,OMP_seqmem_med,OMP_seqmem_err_low,OMP_seqmem_err_high" > "$RESULTS_FILE"

# Pretty header (fixed width columns)
printf "%12s | %25s | %25s | %25s\n" "compute_iters" "GTAP_block SEQmem (ms)" "GTAP_thread SEQmem (ms)" "OpenMP SEQmem (ms)"
printf "%12s-+-%25s-+-%25s-+-%25s\n" "------------" "-------------------------" "-------------------------" "-------------------------"
