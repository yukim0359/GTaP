...
struct TaskContext {
    ...
    TaskHeader task_headers[GTAP_WARP_SIZE];  // task headers for each thread
#endif
};
...
// Queues remain 2D pointer planes by kind; headers/tasks are 1D of size GTAP_NUM_QUEUES*GTAP_MAX_TASKS_GLOBAL
