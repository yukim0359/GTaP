...
# Allow importing `/work/gc64/c64099/plot_style/gtap_colors.py` when run from any subdir of the repo
# This file lives under: .../gtap/evaluation/2-comparison/fib/
...
if not gtap_df.empty and not speedup_df.empty and ("omp_speedup" in speedup_df.columns or "seq_speedup" in speedup_df.columns):
    ...
    ax_bot.set_xlabel("Fibonacci Number (n)")
