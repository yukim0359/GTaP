...
RESULTS_FILE="$COMPARE_DIR/${BENCHMARK_NAME}_performance_results_seqmem.csv"
echo "n,GTAP_block_seqmem_med,GTAP_block_seqmem_err_low,GTAP_block_seqmem_err_high,GTAP_thread_seqmem_med,GTAP_thread_seqmem_err_low,GTAP_thread_seqmem_err_high,OMP_seqmem_med,OMP_seqmem_err_low,OMP_seqmem_err_high" > "$RESULTS_FILE"

# Pretty header (fixed width columns)
printf "%6s | %25s | %25s | %25s\n" "n" "GTAP_block SEQmem (ms)" "GTAP_thread SEQmem (ms)" "OpenMP SEQmem (ms)"
printf "%6s-+-%25s-+-%25s-+-%25s\n" "------" "-------------------------" "-------------------------" "-------------------------"
